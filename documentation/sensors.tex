...
\begin{figure}[ht]
    \centering
    \subfloat[Wind sensor from ThiesKlima]{\label{fig:windsensor} \includegraphics[width=0.5\linewidth]{graphics/windsensor.jpg}} 
    \qquad
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{graphics/windsensor_specs.jpg}
