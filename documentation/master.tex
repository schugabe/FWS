...
\begin{figure}
     \centering 
     \subfloat[Quick overview of the stations and their status]{\label{fig:main} \includegraphics[width=0.4\linewidth]{master/mainview.png}} 
      \qquad
     \subfloat[Configuration of the basic settings]{\label{fig:settings} \includegraphics[width=0.4\linewidth]{master/settings.png}}
      \qquad
      \subfloat[Add new Station]{\label{fig:add} \includegraphics[width=0.4\linewidth]{master/add.png}}
